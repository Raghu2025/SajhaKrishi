...
//        }
    ...
    private boolean isPublicPage(String path) {
        return path.equals(ApiConstant.LOGIN)
            || path.equals(ApiConstant.REGISTER)
            || path.equals(ApiConstant.HOME)
            || path.equals("/")
            || path.startsWith(ApiConstant.CSS)
            || path.startsWith(ApiConstant.JS)
            || path.startsWith(ApiConstant.IMAGES)
            || path.equals(ApiConstant.KISSAN_EQUIPMENT)
